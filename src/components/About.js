  ...
  return (
    <section className="bg-gray-800 rounded-lg p-6">
      ...
      <div className="space-y-4 text-gray-300">
        <p>
          <strong className="text-white">Cloud Security Engineer</strong> with 12+ years of comprehensive experience spanning security architecture, application development, and infrastructure management.
        </p>
